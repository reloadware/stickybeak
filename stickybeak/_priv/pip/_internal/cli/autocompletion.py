...
from stickybeak._priv.pip._internal.cli.main_parser import create_main_parser
from stickybeak._priv.pip._internal.commands import commands_dict, create_command
