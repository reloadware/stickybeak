...
from stickybeak._priv.pip._vendor.six import string_types

from stickybeak._priv.pip._internal.cli.status_codes import UNKNOWN_ERROR
from stickybeak._priv.pip._internal.configuration import Configuration, ConfigurationError
