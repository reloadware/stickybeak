...
import stickybeak._priv.pip._vendor
from stickybeak._priv.pip._vendor import pkg_resources
from stickybeak._priv.pip._vendor.certifi import where

from stickybeak._priv.pip import __file__ as pip_location
...
from stickybeak._priv.pip._internal.utils.misc import get_pip_version
...
if MYPY_CHECK_RUNNING:
    ...
    from stickybeak._priv.pip._internal.configuration import Configuration
...
class DebugCommand(Command):
    ...
    def run(self, options, args):
        ...
        show_value("stickybeak._priv.pip._vendor.certifi.where()", where())
        show_value("stickybeak._priv.pip._vendor.DEBUNDLED", pip._vendor.DEBUNDLED)
