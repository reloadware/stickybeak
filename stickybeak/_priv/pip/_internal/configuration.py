...
from stickybeak._priv.pip._internal.utils import appdirs
from stickybeak._priv.pip._internal.utils.compat import WINDOWS, expanduser
from stickybeak._priv.pip._internal.utils.misc import ensure_dir, enum
...
kinds = enum(
    ...
    ENV="env",          # from stickybeak._priv.pip_CONFIG_FILE
