...
from stickybeak._priv.pip._vendor.six import iteritems
...
if MYPY_CHECK_RUNNING:
    ...
    from stickybeak._priv.pip._vendor.requests.models import Response, Request
    from stickybeak._priv.pip._vendor.six import PY3
...
class HashMissing(HashError):
    ...
    def body(self):
        ...
        from stickybeak._priv.pip._internal.utils.hashes import FAVORITE_HASH
