...
from stickybeak._priv.pip._internal.utils.compat import has_tls
from stickybeak._priv.pip._internal.utils.misc import normalize_path, redact_auth_from_url
