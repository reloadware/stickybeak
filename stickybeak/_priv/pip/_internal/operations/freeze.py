...
from stickybeak._priv.pip._vendor.pkg_resources import RequirementParseError

from stickybeak._priv.pip._internal.exceptions import BadCommand, InstallationError
from stickybeak._priv.pip._internal.req.constructors import (
    install_req_from_editable,
    install_req_from_line,
)
from stickybeak._priv.pip._internal.req.req_file import COMMENT_RE
from stickybeak._priv.pip._internal.utils.direct_url_helpers import (
...
if MYPY_CHECK_RUNNING:
    ...
    from stickybeak._priv.pip._vendor.pkg_resources import (
...
def get_requirement_info(dist):
    ...
    from stickybeak._priv.pip._internal.vcs import vcs, RemoteNotFoundError
