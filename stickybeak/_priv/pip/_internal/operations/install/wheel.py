...
from stickybeak._priv.pip._vendor.distlib.scripts import ScriptMaker
from stickybeak._priv.pip._vendor.distlib.util import get_export_entry
from stickybeak._priv.pip._vendor.six import (
    PY2,
    ensure_str,
    ensure_text,
    itervalues,
...
from stickybeak._priv.pip._vendor.six.moves import filterfalse, map

from stickybeak._priv.pip._internal.exceptions import InstallationError
from stickybeak._priv.pip._internal.locations import get_major_minor_version
from stickybeak._priv.pip._internal.models.direct_url import DIRECT_URL_METADATA_NAME, DirectUrl
from stickybeak._priv.pip._internal.models.scheme import SCHEME_KEYS
from stickybeak._priv.pip._internal.utils.filesystem import adjacent_tmp_file, replace
...
from stickybeak._priv.pip._internal.utils.unpacking import (
    current_umask,
    is_within_directory,
    set_extracted_file_to_default_mode_plus_executable,
    zip_item_is_executable,
)
from stickybeak._priv.pip._internal.utils.wheel import (
    parse_wheel,
...
if not MYPY_CHECK_RUNNING:
    from stickybeak._priv.pip._internal.utils.typing import cast
else:
    ...
    from stickybeak._priv.pip._internal.models.scheme import Scheme
    from stickybeak._priv.pip._internal.utils.filesystem import NamedTemporaryFileResult
