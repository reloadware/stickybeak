...
from stickybeak._priv.pip._vendor.packaging.requirements import InvalidRequirement, Requirement
from stickybeak._priv.pip._vendor.packaging.specifiers import Specifier
from stickybeak._priv.pip._vendor.pkg_resources import RequirementParseError, parse_requirements

from stickybeak._priv.pip._internal.exceptions import InstallationError
from stickybeak._priv.pip._internal.models.index import PyPI, TestPyPI
from stickybeak._priv.pip._internal.models.link import Link
from stickybeak._priv.pip._internal.models.wheel import Wheel
from stickybeak._priv.pip._internal.pyproject import make_pyproject_path
...
from stickybeak._priv.pip._internal.utils.filetypes import ARCHIVE_EXTENSIONS
from stickybeak._priv.pip._internal.utils.misc import is_installable_dir, splitext
from stickybeak._priv.pip._internal.utils.typing import MYPY_CHECK_RUNNING
from stickybeak._priv.pip._internal.utils.urls import path_to_url
from stickybeak._priv.pip._internal.vcs import is_url, vcs

if MYPY_CHECK_RUNNING:
    from typing import (
        Any, Dict, Optional, Set, Tuple, Union,
    )
    from stickybeak._priv.pip._internal.req.req_file import ParsedRequirement
