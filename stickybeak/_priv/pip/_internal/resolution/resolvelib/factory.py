...
from stickybeak._priv.pip._internal.utils.compatibility_tags import get_supported
...
if MYPY_CHECK_RUNNING:
    ...
    from stickybeak._priv.pip._vendor.resolvelib import ResolutionImpossible

    from stickybeak._priv.pip._internal.cache import CacheEntry, WheelCache
