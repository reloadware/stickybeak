...
from stickybeak._priv.pip._internal.utils.compat import WINDOWS
from stickybeak._priv.pip._internal.utils.deprecation import DEPRECATION_MSG_PREFIX
from stickybeak._priv.pip._internal.utils.misc import ensure_dir
...
try:
    ...
    from stickybeak._priv.pip._vendor import colorama as _colorama
...
# ImportError.
    ...
    from stickybeak._priv.pip._vendor.colorama import Fore
...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    handler_classes = {
        "stream": "stickybeak._priv.pip._internal.utils.logging.ColorizedStreamHandler",
        "file": "stickybeak._priv.pip._internal.utils.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "stickybeak._priv.pip._internal.utils.logging.MaxLevelFilter",
            ...
            "exclude_subprocess": {
                "()": "stickybeak._priv.pip._internal.utils.logging.ExcludeLoggerFilter",
                "name": subprocess_logger.name,
            },
        },
        "formatters": {
