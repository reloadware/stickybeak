...
from stickybeak._priv.pip._vendor.retrying import retry  # type: ignore
from stickybeak._priv.pip._vendor.six import PY2, text_type
from stickybeak._priv.pip._vendor.six.moves import filter, filterfalse, input, map, zip_longest
from stickybeak._priv.pip._vendor.six.moves.urllib import parse as urllib_parse
from stickybeak._priv.pip._vendor.six.moves.urllib.parse import unquote as urllib_unquote

from stickybeak._priv.pip import __version__
from stickybeak._priv.pip._internal.exceptions import CommandError
from stickybeak._priv.pip._internal.locations import (
    get_major_minor_version,
    site_packages,
    user_site,
)
from stickybeak._priv.pip._internal.utils.compat import (
    WINDOWS,
    expanduser,
    stdlib_pkgs,
    str_to_display,
)
from stickybeak._priv.pip._internal.utils.typing import MYPY_CHECK_RUNNING, cast
from stickybeak._priv.pip._internal.utils.virtualenv import (
