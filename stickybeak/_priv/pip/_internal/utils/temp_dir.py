...
from stickybeak._priv.pip._vendor.contextlib2 import ExitStack
from stickybeak._priv.pip._vendor.six import ensure_text

from stickybeak._priv.pip._internal.utils.misc import enum, rmtree
