...
from stickybeak.vendored.pip._internal.utils import appdirs
from stickybeak.vendored.pip._internal.utils.compat import WINDOWS, expanduser
from stickybeak.vendored.pip._internal.utils.misc import ensure_dir, enum
...
kinds = enum(
    ...
    ENV="env",          # from stickybeak.vendored.pip_CONFIG_FILE
