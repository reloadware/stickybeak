...
from stickybeak.vendored.pip._vendor.six import iteritems
...
if MYPY_CHECK_RUNNING:
    ...
    from stickybeak.vendored.pip._vendor.requests.models import Response, Request
    from stickybeak.vendored.pip._vendor.six import PY3
...
class HashMissing(HashError):
    ...
    def body(self):
        ...
        from stickybeak.vendored.pip._internal.utils.hashes import FAVORITE_HASH
