...
from stickybeak.vendored.pip._internal.utils.compat import has_tls
from stickybeak.vendored.pip._internal.utils.misc import normalize_path, redact_auth_from_url
