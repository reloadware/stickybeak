...
from stickybeak.vendored.pip._vendor.requests.auth import AuthBase, HTTPBasicAuth
from stickybeak.vendored.pip._vendor.requests.utils import get_netrc_auth
...
if MYPY_CHECK_RUNNING:
    ...
    from stickybeak.vendored.pip._internal.vcs.versioncontrol import AuthInfo
