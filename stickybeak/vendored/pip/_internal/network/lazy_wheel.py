...
from stickybeak.vendored.pip._vendor.six.moves import range
...
from stickybeak.vendored.pip._internal.utils.wheel import pkg_resources_distribution_for_wheel
