...
from stickybeak.vendored.pip._vendor.distlib.scripts import ScriptMaker
from stickybeak.vendored.pip._vendor.distlib.util import get_export_entry
from stickybeak.vendored.pip._vendor.six import (
    PY2,
    ensure_str,
    ensure_text,
    itervalues,
...
from stickybeak.vendored.pip._vendor.six.moves import filterfalse, map

from stickybeak.vendored.pip._internal.exceptions import InstallationError
from stickybeak.vendored.pip._internal.locations import get_major_minor_version
from stickybeak.vendored.pip._internal.models.direct_url import DIRECT_URL_METADATA_NAME, DirectUrl
from stickybeak.vendored.pip._internal.models.scheme import SCHEME_KEYS
from stickybeak.vendored.pip._internal.utils.filesystem import adjacent_tmp_file, replace
...
from stickybeak.vendored.pip._internal.utils.unpacking import (
    current_umask,
    is_within_directory,
    set_extracted_file_to_default_mode_plus_executable,
    zip_item_is_executable,
)
from stickybeak.vendored.pip._internal.utils.wheel import (
    parse_wheel,
...
if not MYPY_CHECK_RUNNING:
    from stickybeak.vendored.pip._internal.utils.typing import cast
else:
    ...
    from stickybeak.vendored.pip._internal.models.scheme import Scheme
    from stickybeak.vendored.pip._internal.utils.filesystem import NamedTemporaryFileResult
