...
from stickybeak.vendored.pip._vendor.contextlib2 import ExitStack
from stickybeak.vendored.pip._vendor.six import ensure_text

from stickybeak.vendored.pip._internal.utils.misc import enum, rmtree
