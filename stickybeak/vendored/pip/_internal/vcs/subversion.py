...
from stickybeak.vendored.pip._internal.vcs.versioncontrol import VersionControl, vcs
...
class Subversion(VersionControl):
    ...
    def _get_svn_url_rev(cls, location):
        from stickybeak.vendored.pip._internal.exceptions import SubProcessError
